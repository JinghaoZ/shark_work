...
<div class="wrap">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                <a href="/work/web/index.php?r=cate/bike" class="btn btn-default btn-doc">Furniture</a>
            </div>
            <div class="clo-sm-3">
    ...
    <div class="container">
        ...
        <div class="col-sm-10 col-sm-offset-1">
            <h3>Furniture     <span class="label label-default">New</span></h3><br><br>
            <div class="row">
                <?php foreach($goods_art as $good_at):?>
                    <a href="<?=\yii\helpers\Url::toRoute(['index/detail','id'=>$good_at['id']])?>" class="thumbnail" target="_blank">
                        <p><?=$good_at['goods_name']?></p>
                        <p>Seller: <?=$good_at['username']?></p>
                        <p>Upload Time<?=date('Y-m-d H:m:s',$good_at['add_time'])?></p>
                        <p><img src="/work/web/uploads/<?=$good_at['logo']?>" alt=""></p>
                    </a>
                <?php endforeach;?>
            </div>
        </div>
