...
<div class="wrap">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-3">
                <form action="/work/web/index.php?r=admin%2Fsearch-user" method="post">
        ...
        <table class="table table-bordered">
            ...
            <?php foreach($users as $user):?>
                <tr>
                    ...
                    <td><?=$user['password']?></td>
                    <td><?=$user['tel']?></td>
                    <td><img src="/work/web/uploads/<?=$user['logo']?>" alt=""></td>
                    <td><a href="<?=\yii\helpers\Url::toRoute(['admin/user-delete','user_id'=>$user['id']])?>" class="btn btn-success btn-sm" role="button">Delete</a></td>
                </tr>
            <?php endforeach;?>
        </table>
