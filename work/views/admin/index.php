...
<div class="wrap">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-3">
                <form action="<?=\yii\helpers\Url::toRoute(['admin/search-order'])?>" method="post">
        ...
        <table class="table table-bordered">
            ...
            <?php foreach($data as $v):?>
                <tr>
                    ...
                    <td><a href="<?=\yii\helpers\Url::toRoute(['order-delete','id'=>$v['id']])?>" class="btn btn-success">Delete</a></td>
                </tr>
            <?php endforeach;?>
        </table>
    </div>
