...
return [
    ...
    'Are you sure you want to delete this item?' => '您确定要Delete此项吗？',
    'Delete' => 'Delete',
    'Error' => '错误',
    'File upload failed.' => '文件上传失败。',
    'Home' => '首页',
    'Invalid data received for parameter "{param}".' => '"{param}"参数接收到无效的数据。',
    'Login Required' => '需要Login',
    ...
    'The verification code is incorrect.' => 'Verify code不正确。',
    ...
    'View' => '查看',
    'Yes' => '是',
    'You are not allowed to perform this action.' => '您没有执行此Operation的权限。',
